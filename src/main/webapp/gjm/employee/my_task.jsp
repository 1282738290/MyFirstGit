...
<div class="cssout">
    <div class="menuboxs">
        <ul>
            <li style="background-color: red;"><a href="${pageContext.request.contextPath}/my_taskload.do">
            ...
            <c:forEach items="${list}" var="s" varStatus="v">
                <tr class="tr" >
                    ...
                    <td nowrap="nowrap" class="td_l_c">
                        <a class="fbtn i-sms" href="${pageContext.request.contextPath}/songshenTask/${s.taskId}/${s.pre_id}.do" onclick="return confirm('确认送审此任务？');">
                            <i class="layui-icon" style="font-weight: bold;">&#xe609;</i>
                            送审&nbsp;</a>
                        <a class="fbtn i-edit" href="${pageContext.request.contextPath}/updateTask/${s.pre_id}.do">
                            <i class="layui-icon" style="font-weight: bold;">&#xe64c;</i>
                            修改&nbsp;</a>
                        <a class="fbtn i-del" href="${pageContext.request.contextPath}/deleteTask/${s.taskId}/${s.processInstanceId}/${s.pre_id}.do" onclick="return confirm('确认删除此任务？');">
                            <i class="layui-icon" style="font-weight: bold;">&#xe640;</i>
                            删除&nbsp;</a>
